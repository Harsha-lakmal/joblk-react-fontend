...
const checkIcon = (
  <svg width="1rem" height="0.75rem" viewBox="0 0 8 6" aria-hidden="true">
...
const crossIcon = (
  <svg width="1rem" height="1rem" viewBox="0 0 8 8" aria-hidden="true">
...
const OfferList = () => (
  <div className="mb-3 flex items-center">
    <span
      className={`mr-3 flex h-[18px] w-[18px] items-center justify-center rounded-full ${
        status === "active" ? "bg-primary bg-opacity-10 text-primary" : "bg-gray-300 text-gray-500"
      }`}
      aria-hidden="true"
    >
