...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base text-body-color dark:border-white dark:border-opacity-25">
        Lorem ipsum dolor sit amet, Sed ullamcorper consectur adipiscing Mae ornare massa quis lectus.
      </p>
      <div>
        <input
          type="text"
          ...
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base outline-none focus:border-primary dark:border-transparent dark:bg-[#2C303B] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary"
        />
        <input
          type="email"
          name="email"
